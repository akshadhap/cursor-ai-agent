...
<div className="flex flex-col items-center">
  ...
  <p className="text-lg">
    {serviceName.toLowerCase() === 'vapi' ? 'Connect to voice agent' : 'Connect your AI Avatar account'}
  </p>
</div>
...
<div className="mb-6">
  ...
  <div className="text-muted-foreground font-medium text-xs">{feature.description}</div>
</div>
